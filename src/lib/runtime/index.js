import { Request, Response, fetch, Headers, freezeHeaders, bindCfProperty } from './fetch.js'
import { URL, URLSearchParams } from 'url'
import streamPolyfill from 'web-streams-polyfill'
import FetchEvent from './fetch-event.js'
import crypto from './crypto.js'
import { TextDecoder, TextEncoder } from './text-encoder.js'
import FunctionProxy from './function.js'
import atob from 'atob'
import btoa from 'btoa'

const { ReadableStream, WritableStream, TransformStream } = streamPolyfill
